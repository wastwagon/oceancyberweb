...
export function Testimonials() {
  ...
  return (
    <section ref={ref} id="testimonials" className="py-32 bg-gradient-to-b from-cyan-50 via-cyan-100 to-cyan-200 relative overflow-hidden">
      {/* Wave pattern */}
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              <div>
                <motion.span
                  ...
                  className="inline-block px-5 py-2.5 bg-cyan-100 border border-cyan-200 rounded-full text-sm font-medium text-white mb-6 tracking-wide"
                >
                  Client Stories
                </motion.span>
              ...
              <p className="text-xl text-white/90 max-w-md font-light md:text-right">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className={`group relative p-8 bg-white/80 backdrop-blur-sm border border-cyan-200/30 rounded-3xl hover:border-cyan-300 hover:bg-white transition-all duration-500 overflow-hidden shadow-lg hover:shadow-xl ${
                index === 1 ? "md:mt-8" : ""
              }`}
            >
              ...
              <div className="relative z-10">
                ...
                {/* Author */}
                <div className="flex items-center gap-4 pt-6 border-t border-cyan-200/30">
