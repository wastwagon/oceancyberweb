          ...
          >
            ...
            <motion.div variants={heroMotion.item} className="mt-10">
              <Link
                ...
                className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-xl border-2 border-[#143296cc] bg-gradient-to-t from-[#143296cc] to-[#00000a] px-8 py-3 text-sm font-bold text-white shadow-lg shadow-[#143296cc]/25 transition-all hover:brightness-110 md:text-base"
              >
      ...
      <section className="relative z-10 border-b border-white/[0.06] py-20 md:py-24">
        <div className="container mx-auto max-w-6xl px-6 md:px-8">
          <motion.div {...fadeUpProps} className="mx-auto mb-12 max-w-2xl text-center md:mb-14">
            ...
            <p className="mt-3 text-slate-400 md:text-base">{content.focusSubtitle}</p>
          </motion.div>
      ...
      <section className="relative z-10 border-b border-white/[0.06] py-20 md:py-24">
        <div className="container mx-auto max-w-6xl px-6 md:px-8">
          <motion.div {...fadeUpProps} className="mx-auto mb-12 max-w-2xl text-center md:mb-14">
            ...
            <p className="mt-3 text-slate-400 md:text-base">{content.stackSubtitle}</p>
          </motion.div>
      ...
      <section className="relative z-10 border-b border-white/[0.06] py-20 md:py-24">
        <div className="container mx-auto max-w-6xl px-6 md:px-8">
          <motion.div {...fadeUpProps} className="mx-auto mb-12 max-w-2xl text-center md:mb-14">
            ...
            <p className="mt-3 text-slate-400 md:text-base">{content.deliverSubtitle}</p>
          </motion.div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6 lg:grid-cols-3">
