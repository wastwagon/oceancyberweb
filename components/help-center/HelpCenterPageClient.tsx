...
type HelpCenterPageClientProps = {
  articles: HelpArticle[];
};

export function HelpCenterPageClient({ articles }: HelpCenterPageClientProps) {
  ...
  async function sendFeedback(articleId: string, helpful: boolean) {
    try {
      ...
      const res = await publicApiFetch("contact/feedback", {
        method: "POST",
            ...
            <motion.aside {...fadeUpProps} className="lg:sticky lg:top-32 h-fit">
              <div className="sa-card p-8">
                ...
                <div className="mt-8 space-y-6">
                  ...
                  <Link href={guided.cta.href} className="sa-btn-primary w-full">
                    {guided.cta.label}
