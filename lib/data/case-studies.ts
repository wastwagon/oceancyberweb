...
export const caseStudies: CaseStudy[] = [
  {
    ...
    year: "2024",
    client: "EGP Ghana",
    challenge: "Legacy banking systems with poor user experience and security vulnerabilities",
    solution: "Modern web application with multi-factor authentication and real-time transaction monitoring",
    impact: "Enhanced customer satisfaction and reduced operational costs by 40%",
    rating: 5,
    slug: "egp-ghana",
  ...
  },
  {
    ...
    year: "2024",
    client: "Juelle Hair",
    challenge: "Manual order processing and limited online presence",
    solution: "Fully automated e-commerce system with real-time inventory tracking",
    impact: "Streamlined operations and expanded customer reach across multiple countries",
    rating: 5,
    slug: "juelle-hair",
  ...
  },
  {
    ...
    challenge: "Disconnected booking systems and poor customer experience",
    solution: "Unified booking platform with mobile-responsive design and automated confirmations",
    impact: "Improved customer retention and reduced booking errors by 90%",
    rating: 5,
  ...
  },
  {
    ...
    challenge: "Limited client interaction capabilities and outdated document sharing process",
    solution: "Modern client portal with secure document management and automated scheduling system",
    impact: "Increased client engagement and streamlined consultation scheduling process",
    rating: 5,
    slug: "fitch-advisory",
  ...
  },
  {
    ...
    challenge: "Disorganized case management and inefficient client communication",
    solution: "Integrated case management system with secure client communication and document sharing",
    impact: "Enhanced case management efficiency and improved client communication",
    rating: 5,
  ...
  },
  {
    ...
    challenge: "Manual nomination process and limited sponsor visibility",
    solution: "Automated nomination and voting system with comprehensive sponsor management and live streaming",
    impact: "Increased nomination submissions and enhanced event participant engagement",
    rating: 5,
  ...
  },
  {
    ...
    challenge: "Disconnected member network and limited business resource sharing",
    solution: "Comprehensive member directory with networking features and centralized trade resource platform",
    impact: "Enhanced member engagement and streamlined business operations",
    rating: 5,
